...
urlpatterns = [
    ...
    path('edit_unapproved_lessons/<str:info>/<int:lesson_numbers>', views.edit_unapproved_lessons, name='edit_unapproved_lessons'), #change the key in the str<>, to the actually key when made
